...
public class Utils {
	...
	//
	// /**
	// * Decode the variable remaining lenght as defined in MQTT v3.1
	// specification
	// * (section 2.1).
	// *
	// * @return the decoded length or -1 if needed more data to decode the
	// length field.
	// */
	...
	// * [0..268435455].
	// */
	// static IoBuffer encodeRemainingLength(int value) throws
	// IllegalAccessException {
	// if (value > MAX_LENGTH_LIMIT || value < 0) {
	// throw new IllegalAccessException("Value should in range 0.." +
	...
	// */
	// static String decodeString(IoBuffer in) throws
