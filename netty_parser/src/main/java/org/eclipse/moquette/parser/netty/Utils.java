...
public class Utils {
	...
	/**
	 * Read a byte array from the buffer, use two bytes as length information
	 * followed by length bytes.
	 * */
	static byte[] readFixedLengthContent(ByteBuf in)
	...
	/**
	 * Return the IoBuffer with string encoded as MSB, LSB and bytes array
	 * content.
	 */
	...
	static boolean isMQTT3_1_1(AttributeMap attrsMap) {
		Attribute<Integer> versionAttr = attrsMap
				.attr(MQTTDecoder.PROTOCOL_VERSION);
