...
public class Subscription implements Serializable {
	...
	private QOSType				requestedQos;				// max QoS
															// acceptable
	...
	public Subscription(String clientId, String topicFilter,
			QOSType requestedQos, boolean cleanSession) {
	 ...
	 */
	public static final Subscription createEmptySubscription(String clientId,
	...
	public boolean equals(Object o) {
		...
		if (clientId != null ? !clientId.equals(that.clientId)
				: that.clientId != null)
			return false;
		if (requestedQos != that.requestedQos)
			return false;
		if (topicFilter != null ? !topicFilter.equals(that.topicFilter)
				: that.topicFilter != null)
			return false;
	...
	public int hashCode() {
		...
		result = 31 * result
				+ (topicFilter != null ? topicFilter.hashCode() : 0);
	...
	public String toString() {
		return String
				.format("[filter:%s, cliID: %s, qos: %s, active: %s]",
						this.topicFilter, this.clientId, this.requestedQos,
						this.active);
	}
