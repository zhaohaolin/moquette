...
public interface IMessagesStore {
	...
	/**
	 * Persist the message. If the message is empty then the topic is cleaned,
	 * else it's stored.
	 */
	void storeRetained(String topic, ByteBuffer message,
	...
	/**
	 * Return the list of persisted publishes for the given clientID. For QoS1
	 * and QoS2 with clean session flag, this method return the list of missed
	 * publish events while the client was disconnected.
	 */
