...
/**
 * Parses the acl configuration file. If a line starts with # it's comment.
 * Blank lines are skipped. The format is
...
public class ACLFileParser {
	...
	private static final Logger	LOG	= LoggerFactory
											.getLogger(ACLFileParser.class);
	
	/**
	 * Parse the configuration from file.
	 */
	public static AuthorizationsCollector parse(File file)
	 ...
	 */
	public static AuthorizationsCollector parse(Reader reader)
			throws ParseException {
		if (reader == null) {
