 ...
 * ACL checker.
 * 
 * Create an authorizator that matches topic names with same grammar of
 * subscriptions. The # is always a terminator and its the multilevel matcher.
...
public interface IAuthorizator {
	...
	/**
	 * Ask the implementation of the authorizator if the topic can be used in a
	 * publish.
	 * */
