...
public class NettyUtils {
	...
	public static Object getAttribute(ChannelHandlerContext channel,
			AttributeKey<Object> key) {
		Attribute<Object> attr = channel.attr(key);
		return attr.get();
	}
	
	public static void setAttribute(ChannelHandlerContext channel,
			AttributeKey<Object> key, Object value) {
		Attribute<Object> attr = channel.attr(key);
		attr.set(value);
	}
	...
	public static void setIdleTime(ChannelHandlerContext channel, int idleTime) {
		...
		channel.pipeline().addAfter("idleStateHandler", "idleEventHandler",
				new MoquetteIdleTimoutHandler(null));
	}
}
